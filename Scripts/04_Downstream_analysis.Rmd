...
```
```{r Remove cells with abnormal total RNA counts; automatically detects outliers}
...
```{rr Total variance explained across the top 35 PCs}
...
```{rDimention reduction plot on PCA}
